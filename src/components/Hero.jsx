...
export default function Hero() {
  ...
  const curentfloatingcards = floatingCards[activeTab];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div
        ...
        style={{
          background: `radial-gradient(600px circle at ${mousePosition.x}px ${mousePosition.y}px,rgba(59,140,246,0.15),transparent 40%)`,
        }}
      />

      <div className="absolute top-20 left-4 sm:left-10 w-48 sm:w-72 h-48 bg-blue-500/10 rounded-full blur-3xl animate-pulse " />
      <div className="absulute bottom-20 right-4 sm:right-10 w-64 sm:w-64 h-64 sm:h-96 bg-cyan-500/10 rounded-full blur-3xl animate-pulse delay-1000" />
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 text-center lg:text-left  gap-6 sm:gap-8 lg:gap-12 items-center relative ">
          <div>
            ...
            <h1 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold mb-4 sm:mb-6  animate-in slide-in-from-bottom duration-700 delay-100 leading-tight ">
              <span className="bg-gradient-to-r from-white via-blue-100 to-cyan-10 bg-clip-text text-transparent block mb-1 sm:mb-1 ">
                Code Faster
              </span>
              <span className="bg-gradient-to-b from-blue-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent block mb-1 sm:mb-1 ">
                Build Better
              </span>
              <span className="bg-gradient-to-r from-white via-blue-100 to-cyan-10 bg-clip-text text-transparent block mb-1 sm:mb-1 ">
                With Code Flow AI
            ...
            <p className="text-md sm:text-base lg:text-lg text-gray-400 max-w-2xl mx-auto lg:mx-0 mb-6 sm:mb-8 animate-in  slide-in-from-bottom duration-700 delay-200 leading-relaxed">
              ...
              id fugit at possimus blanditiis sint ipsam tempore, tenetur
              laborum consequatur.
            </p>
            ...
            <div className="relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10">
              <div className="bg-gradient-to-br from-gray-900/20  to-gray-800/20 backdrop-blur-sm rounded-lg overflow-hidden h-[280px] sm:h-[350px] lg:h-[450px] border border-white/5">
                ...
                <div className="p-3 sm:p-4 relative h-full ">
                  {/* file tab */}
                  <div className="flex space-x-1 sm:space-2 mb-3 sm:mb-4 overflow-x-auto">
                    <button
              ...
              >
                <div className="flex items-center space-x-2 mb-2 ">
                  <div
                    className={`w-6 h-6 ${curentfloatingcards.iconColor} flex items-center justify-center text-sm font-bold`}
                  >
                    {curentfloatingcards.icon}
                  </div>
                  <span
                    className={`text-sm font-medium ${curentfloatingcards.textColor}`}
                  >
                    {curentfloatingcards.title}
                  </span>
                </div>
                <div
                  className={`text-sm text-left ${curentfloatingcards.contextColor}`}
                >
                  {curentfloatingcards.content}
                </div>
              </div>
            </div>
          </div>
